...
import net.minecraft.client.item.ItemCloth;
import net.minecraft.client.item.ItemLeaves;
import net.minecraft.client.item.ItemLog;
import net.minecraft.client.item.ItemPiston;
import net.minecraft.client.item.ItemSapling;
import net.minecraft.client.item.ItemSlab;
