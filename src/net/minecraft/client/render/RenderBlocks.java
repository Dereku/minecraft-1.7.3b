...
public class RenderBlocks {
    ...
    public boolean renderBlockFire(Block block, int i, int j, int k) {
        ...
        if (!this.blockAccess.isBlockNormalCube(i, j - 1, k) && !Block.fire.canBlockCatchFire(this.blockAccess, i, j - 1, k)) {
            ...
            if (Block.fire.canBlockCatchFire(this.blockAccess, i - 1, j, k)) {
                tessellator.addVertexWithUV((double) ((float) i + ff), (double) ((float) j + f1 + f4), (double) (k + 1), d2, d4);
                ...
                tessellator.addVertexWithUV((double) ((float) i + ff), (double) ((float) j + f1 + f4), (double) (k + 0), d, d4);
                tessellator.addVertexWithUV((double) ((float) i + ff), (double) ((float) j + f1 + f4), (double) (k + 0), d, d4);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) (j + 0) + f4), (double) (k + 0), d, d6);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) (j + 0) + f4), (double) (k + 1), d2, d6);
                tessellator.addVertexWithUV((double) ((float) i + ff), (double) ((float) j + f1 + f4), (double) (k + 1), d2, d4);
            ...
            if (Block.fire.canBlockCatchFire(this.blockAccess, i + 1, j, k)) {
                tessellator.addVertexWithUV((double) ((float) (i + 1) - ff), (double) ((float) j + f1 + f4), (double) (k + 0), d, d4);
                ...
                tessellator.addVertexWithUV((double) ((float) (i + 1) - ff), (double) ((float) j + f1 + f4), (double) (k + 1), d2, d4);
                tessellator.addVertexWithUV((double) ((float) (i + 1) - ff), (double) ((float) j + f1 + f4), (double) (k + 1), d2, d4);
                tessellator.addVertexWithUV((double) (i + 1 - 0), (double) ((float) (j + 0) + f4), (double) (k + 1), d2, d6);
                tessellator.addVertexWithUV((double) (i + 1 - 0), (double) ((float) (j + 0) + f4), (double) (k + 0), d, d6);
                tessellator.addVertexWithUV((double) ((float) (i + 1) - ff), (double) ((float) j + f1 + f4), (double) (k + 0), d, d4);
            ...
            if (Block.fire.canBlockCatchFire(this.blockAccess, i, j, k - 1)) {
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) j + f1 + f4), (double) ((float) k + ff), d2, d4);
                ...
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) j + f1 + f4), (double) ((float) k + ff), d, d4);
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) j + f1 + f4), (double) ((float) k + ff), d, d4);
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) (j + 0) + f4), (double) (k + 0), d, d6);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) (j + 0) + f4), (double) (k + 0), d2, d6);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) j + f1 + f4), (double) ((float) k + ff), d2, d4);
            ...
            if (Block.fire.canBlockCatchFire(this.blockAccess, i, j, k + 1)) {
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) j + f1 + f4), (double) ((float) (k + 1) - ff), d, d4);
                ...
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) j + f1 + f4), (double) ((float) (k + 1) - ff), d2, d4);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) j + f1 + f4), (double) ((float) (k + 1) - ff), d2, d4);
                tessellator.addVertexWithUV((double) (i + 0), (double) ((float) (j + 0) + f4), (double) (k + 1 - 0), d2, d6);
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) (j + 0) + f4), (double) (k + 1 - 0), d, d6);
                tessellator.addVertexWithUV((double) (i + 1), (double) ((float) j + f1 + f4), (double) ((float) (k + 1) - ff), d, d4);
            ...
            tessellator.addVertexWithUV(f3, (double) (j + 0), (double) (k + 1), d2, d6);
            tessellator.addVertexWithUV(f3, (double) (j + 0), (double) (k + 0), d, d6);
    ...
    public boolean renderBlockFluids(Block block, int i, int j, int k) {
        ...
        if (!flag && !flag1 && !aflag[0] && !aflag[1] && !aflag[2] && !aflag[3]) {
            ...
            if (this.renderAllFaces || flag1) {
                float ff = block.getBlockBrightness(this.blockAccess, i, j - 1, k);
            ...
            for (k1 = 0; k1 < 4; ++k1) {
                ...
                int jj = block.getBlockTextureFromSideAndMetadata(k1 + 2, i1);
                int j3 = (jj & 15) << 4;
                int kk = jj & 240;
                ...
                if (this.renderAllFaces || aflag[k1]) {
                    ...
                    tessellator.addVertexWithUV((double) f17, (double) ((float) jj + f13), (double) f19, d4, d6);
                    tessellator.addVertexWithUV((double) f20, (double) ((float) jj + f15), (double) f21, d5, d7);
                    tessellator.addVertexWithUV((double) f20, (double) (jj + 0), (double) f21, d5, d8);
                    tessellator.addVertexWithUV((double) f17, (double) (jj + 0), (double) f19, d4, d8);
                }
            }
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block block, int i, int j, int k, float f, float f1, float f2) {
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i, j - 1, k, 0)) {
            if (this.field_22352_G > 0) {
                ...
                f16 = (this.field_22376_n + this.field_22377_m + this.aoLightValueYNeg + this.field_22374_p) / 4.0F;
            } else {
                f30 = this.aoLightValueYNeg;
                f23 = this.aoLightValueYNeg;
                f16 = this.aoLightValueYNeg;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i, j + 1, k, 1)) {
            if (this.field_22352_G > 0) {
                ...
                f16 = (this.aoLightValueYPos + this.field_22366_x + this.field_22364_z + this.field_22365_y) / 4.0F;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i, j, k - 1, 2)) {
            if (this.field_22352_G > 0) {
                ...
                f16 = (this.aoLightValueZNeg + this.field_22366_x + this.field_22356_D + this.field_22365_y) / 4.0F;
                ...
                f23 = this.aoLightValueZNeg;
                f16 = this.aoLightValueZNeg;
            ...
            if (RenderBlocks.fancyGrass && k1 == 3 && this.overrideBlockTexture < 0) {
                this.colorRedTopLeft *= f;
                this.colorRedBottomLeft *= f;
                this.colorRedBottomRight *= f;
                this.colorRedTopRight *= f;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i, j, k + 1, 3)) {
            if (this.field_22352_G > 0) {
                ...
                f16 = (this.field_22375_o + this.field_22354_E + this.field_22373_q + this.aoLightValueZPos) / 4.0F;
            } else {
                f30 = this.aoLightValueZPos;
                f23 = this.aoLightValueZPos;
                f16 = this.aoLightValueZPos;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i - 1, j, k, 4)) {
            if (this.field_22352_G > 0) {
                ...
                f16 = (this.field_22358_C + this.aoLightValueXNeg + this.field_22369_u + this.field_22368_v) / 4.0F;
                f23 = (this.field_22377_m + this.field_22376_n + this.field_22358_C + this.aoLightValueXNeg) / 4.0F;
            } else {
                f30 = this.aoLightValueXNeg;
                f23 = this.aoLightValueXNeg;
                f16 = this.aoLightValueXNeg;
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i + 1, j, k, 5)) {
            if (this.field_22352_G > 0) {
                ...
                f23 = this.aoLightValueXPos;
                f16 = this.aoLightValueXPos;
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block block, int i, int j, int k, float f, float f1, float f2) {
        ...
        if (this.renderAllFaces || block.shouldSideBeRendered(this.blockAccess, i, j, k + 1, 3)) {
            ...
            this.renderWestFace(block, (double) i, (double) j, (double) k, k1);
            if ((RenderBlocks.fancyGrass || Config.isBetterGrass()) && k1 == 3 && this.overrideBlockTexture < 0) {
                tessellator.setColorOpaque_F(f11 * f25 * f, f14 * f25 * f1, f17 * f25 * f2);
                this.renderWestFace(block, (double) i, (double) j, (double) k, 38);
            }
    ...
    static {
        for (int i = 0; i < RenderBlocks.redstoneColors.length; ++i) {
