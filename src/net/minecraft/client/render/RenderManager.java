...
import net.minecraft.client.render.RenderArrow;
import net.minecraft.client.render.RenderBiped;
import net.minecraft.client.render.RenderBoat;
import net.minecraft.client.render.RenderChicken;
import net.minecraft.client.render.RenderCow;
import net.minecraft.client.render.RenderCreeper;
import net.minecraft.client.render.RenderEngine;
import net.minecraft.client.render.RenderEntity;
import net.minecraft.client.render.RenderFallingSand;
import net.minecraft.client.render.RenderFireball;
import net.minecraft.client.render.RenderFish;
import net.minecraft.client.render.RenderGhast;
import net.minecraft.client.render.RenderGiantZombie;
import net.minecraft.client.render.RenderItem;
import net.minecraft.client.render.RenderLightningBolt;
import net.minecraft.client.render.RenderLiving;
import net.minecraft.client.render.RenderMinecart;
import net.minecraft.client.render.RenderPainting;
import net.minecraft.client.render.RenderPig;
import net.minecraft.client.render.RenderPlayer;
import net.minecraft.client.render.RenderSheep;
import net.minecraft.client.render.RenderSlime;
import net.minecraft.client.render.RenderSnowball;
import net.minecraft.client.render.RenderSpider;
import net.minecraft.client.render.RenderSquid;
import net.minecraft.client.render.RenderTNTPrimed;
import net.minecraft.client.render.RenderWolf;
