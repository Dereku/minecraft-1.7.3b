...
public abstract class GuiContainer extends GuiScreen {
   ...
   private void drawSlotInventory(Slot var1) {
      ...
      if(var4 == null) {
         ...
         if(var5 >= 0) {
            GL11.glDisable(2896 /*GL_LIGHTING*/);
            this.mc.renderEngine.bindTexture(this.mc.renderEngine.getTexture(Minecraft.ITEMS_TEXTURE));
   ...
   protected void mouseClicked(int var1, int var2, int var3) {
      ...
      if(var3 == 0 || var3 == 1) {
         ...
         if(var8 != -1) {
            ...
            this.mc.playerController.windowClick(this.inventorySlots.windowId, var8, var3, var9, this.mc.thePlayer);
         }
      }
