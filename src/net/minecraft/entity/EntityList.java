...
public class EntityList {
    ...
    private static final Map<String, Class> stringToClassMapping = new HashMap<>();
    private static final Map<Class, String> classToStringMapping = new HashMap<>();
    private static final Map<Integer, Class> IDtoClassMapping = new HashMap<>();
    private static final Map<Class, Integer> classToIDMapping = new HashMap<>();
    ...
    public static Entity createEntityInWorld(String var0, World var1) {
        ...
        try {
            Class var3 = stringToClassMapping.get(var0);
            if (var3 != null) {
                var2 = (Entity) var3.getConstructor(new Class[]{World.class}).newInstance(new Object[]{var1});
            }
        } catch (NoSuchMethodException | SecurityException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException var4) {
    ...
    public static Entity createEntityFromNBT(NBTTagCompound var0, World var1) {
        ...
        try {
            Class var3 = stringToClassMapping.get(var0.getString("id"));
            if (var3 != null) {
                var2 = (Entity) var3.getConstructor(new Class[]{World.class}).newInstance(new Object[]{var1});
            }
        } catch (NoSuchMethodException | SecurityException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException var4) {
