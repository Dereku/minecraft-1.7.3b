...
public abstract class Entity {
    ...
    public void moveEntity(double var1, double var3, double var5) {
        if (this.noClip) {
            ...
            if (var18) {
                double var19;
                for (var19 = 0.05D; var1 != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.getOffsetBoundingBox(var1, -1.0D, 0.0D)).isEmpty(); var11 = var1) {
                ...
                for (; var5 != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.getOffsetBoundingBox(0.0D, -1.0D, var5)).isEmpty(); var15 = var5) {
