...
public class GuiMultiplayer extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.serverTextField = new GuiTextField(this, this.fontRenderer, this.width / 2 - 100, this.height / 4 - 10 + 50 + 18, 200, 20, var2);
   ...
   protected void actionPerformed(GuiButton var1) {
      if(var1.enabled) {
         if(var1.id == 1) {
            ...
            String var2 = this.serverTextField.getText().trim();
