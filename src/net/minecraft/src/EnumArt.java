...
public enum EnumArt {
   ...
   // $FF: synthetic field
   private static final EnumArt[] allArt = new EnumArt[]{Kebab, Aztec, Alban, Aztec2, Bomb, Plant, Wasteland, Pool, Courbet, Sea, Sunset, Creebet, Wanderer, Graham, Match, Bust, Stage, Void, SkullAndRoses, Fighters, Pointer, Pigscene, BurningSkull, Skeleton, DonkeyKong};
