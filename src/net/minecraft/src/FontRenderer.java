...
public class FontRenderer {
    ...
    private void initialize(GameSettings par1GameSettings, String par2Str, RenderEngine par3RenderEngine) {
...
//        this.boundTextureName = this.glyphTextureName[par1];
    ...
    private String bidiReorder(String par1Str) {
        if (FontRenderer.betterFontsEnabled && this.stringCache != null) {
            return par1Str;
        }
