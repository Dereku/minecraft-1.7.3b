...
public class NetworkManager {
    ...
    // $FF: synthetic method
    public static boolean readNetworkPacket(NetworkManager var0) {
        return var0.readPacket();
    }

    // $FF: synthetic method
    public static boolean sendNetworkPacket(NetworkManager var0) {
    ...
    // $FF: synthetic method
    public static boolean func_28138_e(NetworkManager var0) {
        return var0.isTerminating;
    }

    // $FF: synthetic method
    public static void func_30005_a(NetworkManager var0, Exception var1) {
