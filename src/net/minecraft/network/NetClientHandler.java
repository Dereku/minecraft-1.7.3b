...
public class NetClientHandler extends NetHandler {
    ...
    public NetClientHandler(Minecraft var1, String var2, int var3) throws UnknownHostException, IOException {
        this.mc = var1;
        socket = new Socket(InetAddress.getByName(var2), var3);
    ...
    public void handlePickupSpawn(Packet21PickupSpawn var1) {
        ...
        EntityItem var8 = new EntityItem(this.worldClient, var2, var5, var6, new ItemStack(var1.itemID, var1.count, var1.itemDamage));
        ...
        this.worldClient.addEntity(var1.entityId, var8);
    }
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn var1) {
        ...
        Entity var8 = null;
        if (var1.type == 10) {
            var8 = new EntityMinecart(this.worldClient, var2, var5, var6, 0);
        } else if (var1.type == 11) {
            var8 = new EntityMinecart(this.worldClient, var2, var5, var6, 1);
        } else if (var1.type == 12) {
            var8 = new EntityMinecart(this.worldClient, var2, var5, var6, 2);
        } else if (var1.type == 90) {
            var8 = new EntityFish(this.worldClient, var2, var5, var6);
        } else if (var1.type == 60) {
            var8 = new EntityArrow(this.worldClient, var2, var5, var6);
        } else if (var1.type == 61) {
            var8 = new EntitySnowball(this.worldClient, var2, var5, var6);
        } else if (var1.type == 63) {
            var8 = new EntityFireball(this.worldClient, var2, var5, var6, (double) var1.field_28047_e / 8000.0D, (double) var1.field_28046_f / 8000.0D, (double) var1.field_28045_g / 8000.0D);
            var1.field_28044_i = 0;
        } else if (var1.type == 62) {
            var8 = new EntityEgg(this.worldClient, var2, var5, var6);
        } else if (var1.type == 1) {
            var8 = new EntityBoat(this.worldClient, var2, var5, var6);
        } else if (var1.type == 50) {
            var8 = new EntityTNTPrimed(this.worldClient, var2, var5, var6);
        } else if (var1.type == 70) {
            var8 = new EntityFallingSand(this.worldClient, var2, var5, var6, Block.sand.blockID);
        } else if (var1.type == 71) {
            var8 = new EntityFallingSand(this.worldClient, var2, var5, var6, Block.gravel.blockID);
        }
    ...
    public void handleWeather(Packet71Weather var1) {
        ...
        double var5 = (double) var1.posY / 32.0D;
        double var6 = (double) var1.posZ / 32.0D;
        if (var1.isLightningBolt == 1) {
            EntityLightningBolt var8 = new EntityLightningBolt(this.worldClient, var2, var5, var6);
    ...
    public void handleEntityPainting(Packet25EntityPainting var1) {
        ...
        this.worldClient.addEntity(var1.entityId, var2);
    }
    ...
    public void handleNamedEntitySpawn(Packet20NamedEntitySpawn var1) {
        ...
        var10.setPositionAndRotation(var2, var5, var6, var8, var9);
        this.worldClient.addEntity(var1.entityId, var10);
    }
    ...
    private Entity getEntityByID(int var1) {
        return (Entity) (var1 == this.mc.thePlayer.entityId ? this.mc.thePlayer : this.worldClient.getEntity(var1));
    }
